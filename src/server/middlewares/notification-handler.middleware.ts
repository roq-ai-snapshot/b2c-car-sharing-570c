...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'New Vehicle Added.create': {
    roles: ['owner', 'fleet-manager', 'admin', 'business-owner', 'operations-staff'],
    key: 'car_added',
    tenantPath: [],
    userPath: [],
  },
  'New Booking.create': {
    roles: ['owner', 'fleet-manager', 'admin', 'business-owner', 'car-manager', 'operations-staff'],
    key: 'new_booking',
    tenantPath: [],
    userPath: [],
  },
  'Vehicle Unavailable.update': {
