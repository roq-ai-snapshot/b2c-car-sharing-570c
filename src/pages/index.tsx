  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="B2C Car sharing v1 - Transforming the way you book cars. Discover, book and drive cars near you with ease, all managed seamlessly by our dedicated operations team."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`B2C Car sharing v1 - Transforming the way you book cars. Discover, book and drive cars near you with ease, all managed seamlessly by our dedicated operations team.`}
            </Text>
            <Box
